...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--seg_nc', type=int, default=3, help='# of input segmentation channels')
        self.parser.add_argument('--no_seg_input', action='store_true', help='if specified, do *not* add segmentation map as input')
