function [Centers_Best,MSE_Best,Class_Idx_Best,idx_Best,Centers_set,MSE_set,Current_iters] = Kmeans_function_alpha4(SortedAllPixels,n_clusters,initial_method)
%{
2020/02/04
1. add initial_centers_Threshold_alpha1
...
elseif initial_method == 2
    [Centers_Initial,Centers_Initial_idx] = initial_centers_Threshold_alpha1(SortedAllPixels,n_clusters);
else
